                ...
                <div class="main-menu">
                    <div class="app-sidebar__user">
                        <div class="dropdown user-pro-body text-center">
                            <div class="user-pic">
                                <img src="/images/users/16.jpg" alt="user-img" class="avatar-xxl rounded-circle mb-1">
                            </div>
                            <div class="user-info">
                        ...
                        <div class="text-center">
                            <div>
                                ...
                                <div class="bg-layer py-4">
                                    <img src="/images/photos/announcement-1.png" class="py-3 text-center mx-auto" alt="img">
                                </div>
